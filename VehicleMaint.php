...
//-------------------------------
    ?>
      ...
      <tr>
       ...
       <td>
         <span style="font-size: 12pt; color: #000000"><select class="form-control"  size="1" name="category_id">
<?php
...
?></select></span>
      ...
      <tr>
       <td>
         <span style="font-size: 12pt; color: #000000">Product URL</span>
       </td>
       <td>
         <span style="font-size: 12pt; color: #000000">
           <input class="form-control" type="text" name="product_url" maxlength="100" value="<?php echo tohtml($fldproduct_url); ?>" size="40" ></span>
       </td>
     </tr>
      <tr>
       <td>
...
<?php } ?>
  ...
  <input type="hidden" name="Trn_category_id" value="<?php echo $trn_category_id; ?>">
